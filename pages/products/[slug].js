...
const Post = ({addToCart,removeFromCart}) => {
    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-10 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-96 h-80 mt-10 px-20 object-top rounded" src="https://m.media-amazon.com/images/I/613k0gYkdZS._UY879_.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">CodesWear</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Wear the code(Sm/Shade)</h1>
            ...
            <div className="pin mt-5 flex space-x-2 text-sm">
              <input type="number" onChange = {onPinChange} placeholder="Enter Your PinCode" className="px-3 border-2 border-orange-200 rounded" />
              <button onClick = {checkService} className="flex ml-14 text-white bg-orange-500 border-0 py-2 px-4 focus:outline-none hover:bg-orange-600 rounded">CheckPin</button>
            </div>
           {(!service && service!=null) && <div className="text-red-500 mt-3">
              Sorry! We do not deliver to this pincode yet.
            </div>}
            {(service && service!=null) && <div className="text-green-500 mt-3">
