      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-orange-500">CodesWear-Wear the code</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Love coding? Love Fashion? Then why not combine both!</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Get prenium quality products with a coding look only at <Link href="/"><span className="text-blue-500 cursor-pointer">codesWear.com</span></Link></p>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-orange-500 p-6 rounded-lg">
                <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-orange-100 text-orange-500 mb-4">
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6 hover:text-black  " viewBox="0 0 24 24">
